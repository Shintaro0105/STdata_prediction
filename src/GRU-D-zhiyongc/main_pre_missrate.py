...
if __name__ == "__main__":
    ...
    output_path = "/workspaces/STdata_prediction/src/GRU-D-zhiyongc/output/missrate_BAY_8_GRUD.csv"
    ...
    for mask_ones_proportion in np.arange(1.0, -0.1, -0.1):
        ...
        train_dataloader, valid_dataloader, test_dataloader, max_speed, X_mean = PrepareDataset(
            speed_matrix, BATCH_SIZE=32, masking=True, mask_ones_proportion=mask_ones_proportion, split_num=8
        )
        ...
        [mean_l1, std_l1, MAE_, MAPE_] = Test_Model(best_grud, test_dataloader, max_speed)
